...
Migrations are ordered and immutable once merged. The current cumulative schema is `0001` through `0008` and covers the 0.3 resource, identity, RBAC, audit, persistence and Change/Job baseline; CAS-versioned distributed core objects; persistent Network Zone/Interface contract types; and additive built-in RBAC synchronization.
