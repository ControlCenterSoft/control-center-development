...
Статус на 10.09.2026: последний опубликованный исходный релиз — **0.12.0**. Отдельный стабильный бинарный канал распространения подтверждён до **0.3.1**. Наличие кандидатной версии не означает пользовательскую доступность до её официальной публикации.
...
## 2. Опубликованная Capacity Intelligence линия 0.7–0.12
...
## 3. Текущая кандидатная Capacity-линия после 0.12.0
