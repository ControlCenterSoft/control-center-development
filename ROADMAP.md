...
Статус на 10.09.2026: последний опубликованный исходный релиз — **0.15.0**. Отдельный стабильный бинарный канал распространения на момент этой редакции подтверждён до **0.3.1**.
...
- **0.15.0** — bounded nonlinear Workload Curve: piecewise interpolation только внутри измеренного диапазона и запрет extrapolation за пределы подтверждённого evidence.

Общий safety contract линии 0.7–0.15:
...
## 3. Текущая кандидатная линия после 0.15.0
