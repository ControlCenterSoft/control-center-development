...
Статус на 10.09.2026: последний опубликованный исходный релиз — **0.13.0**. Отдельный стабильный бинарный канал распространения на момент этой редакции подтверждён до **0.3.1**.
...
Общий safety contract линии 0.7–0.13:
...
## 3. Текущая кандидатная линия после 0.13.0
...
- **0.14.0** — Benchmark-backed Workload Profile: построение воспроизводимой безопасной workload boundary по измеренным utilization/error/P95 latency samples;
