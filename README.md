...
**Последний опубликованный исходный релиз:** `0.13.0`.
...
Линия до `0.13.0` включает базовые Core-контракты, multi-node lifecycle foundation, Site Autonomy и Network Foundation, а также последовательное развитие advisory Capacity Intelligence.
