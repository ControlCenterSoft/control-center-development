...
**Последний опубликованный исходный релиз:** `0.15.0`.
...
Линия до `0.15.0` включает базовые Core-контракты, multi-node lifecycle foundation, Site Autonomy и Network Foundation, а также последовательное развитие advisory Capacity Intelligence.
...
- `0.15.0` — bounded nonlinear Workload Curve с piecewise interpolation только внутри измеренного диапазона и запретом extrapolation за пределы evidence.
...
- [`docs/RELEASE_0.15.0_RU.md`](docs/RELEASE_0.15.0_RU.md) — состав текущего опубликованного исходного релиза.
