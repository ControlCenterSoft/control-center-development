...
- Последний официально опубликованный canonical/source release: **0.25.0**.
...
- **0.26.0** остаётся release candidate и не считается опубликованной пользовательской версией до завершения собственного release cycle.
