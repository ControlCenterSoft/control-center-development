...
candidate_version="${CANDIDATE_VERSION:-0.32.0}"
[[ "$candidate_version" == "0.32.0" ]] || { echo "unexpected candidate version: $candidate_version" >&2; exit 2; }
...
for doc in docs/RELEASE_0.32.0_RU.md docs/RELEASE_CANDIDATE_READINESS_0.32_RU.md docs/QUALIFICATION_0.32_UPGRADE_FROM_0.31_RU.md docs/QUALIFICATION_0.32_RELEASE_PROMOTION_GATE_RU.md; do
