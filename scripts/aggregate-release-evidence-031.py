...
def main() -> int:
    ...
    qualification_path = root / "control-center-0.31.0.qualification.json"
    provenance_path = root / "control-center-0.31.0.provenance.json"
    manifest_path = root / "control-center-0.31.0.release-manifest.json"
    ...
    readiness = {
        ...
        "gates": [
            ...
            passed("upgrade_from_stable_0_30", qualification_digest),
