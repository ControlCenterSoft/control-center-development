...
EXPECTED_ARTIFACTS = (
    ...
    "control-center-0.32.1-linux-amd64.tar.gz.sha256",
    "control-center-0.32.1-source.tar.gz",
    "control-center-0.32.1.sbom.cdx.json",
    "THIRD_PARTY_NOTICES.md",
    "control-center-0.32.1.provenance.json",
    "control-center-0.32.1.qualification.json",
    "control-center-0.32.1.release-manifest.json",
)
...
def main() -> int:
    ...
    qualification_path = root / "control-center-0.32.1.qualification.json"
    provenance_path = root / "control-center-0.32.1.provenance.json"
    manifest_path = root / "control-center-0.32.1.release-manifest.json"
    ...
    workflow_evidence = {
        "schema": "control-center.candidate-workflow-evidence.v1",
    ...
    readiness = {
        ...
        "candidate_sha": candidate_sha,
        "gates": [
            passed("manual_retry_lineage_integration", workflow_digest),
            passed("operational_workflow_e2e", workflow_digest),
            ...
            passed("security_privacy", workflow_digest),
            {
    ...
    print("RELEASE_EVIDENCE_AGGREGATION=PASS")
